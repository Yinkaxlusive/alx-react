...
OA//   const wrapper = shallow(<Notifications listNotifications={listNotifications} handleDisplayDrawer={mockFn} />);
OA//   const spy = jest.spyOn(wrapper.instance().props, "handleDisplayDrawer");
OA
...
OAit("should call handleHideDrawer when close button is clicked", () => {
OA  const listNotifications = [
OA    { id: 1, type: "default", value: "New course available" },
OA    { id: 2, type: "urgent", value: "New resume available" },
    { id: 3, type: "default", html: getLatestNotification() },
  ];
  const mockFn = jest.fn();
